...
const nomeInfo = document.querySelector('.nome');
...
function questionCounter(index){
    ...
    questionTotal.textContent=`${index} of ${questions.length} Questões`;
}
...
function showResultBox(){
    ...
    let progress = setInterval(() =>{
        ...
        circularProgress.style.background =` conic-gradient(#5F4A8C,${progressStarValue *3.6}deg,rgba(255,255,255,.2) 0deg)`
